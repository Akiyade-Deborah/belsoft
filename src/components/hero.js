...
const Hero = () => {
  ...
  //       {/* Large Frame Image */}
  //       <div className="absolute top-[50px] left-[20px] sm:left-[50px] w-[100%] sm:w-[822px] h-[auto] sm:h-[681px] overflow-hidden">
  //         <Image
  //           src="/frame 25.png"
  //           alt="Event Preview"
  //           width={822}
  ...
  //       {/* Vector Image */}
  //       <div className="absolute top-[103px] left-[50px] sm:left-[50px] w-[100%] sm:w-[997px] h-[auto] sm:h-[1125.5px] overflow-hidden">
  //         <Image
  //           src="/vector 1.svg"
  ...
  //       {/* Group Image */}
  //       <div className="absolute top-[237.65px] left-[50px] sm:left-[946.38px] w-[100%] sm:w-[700.03px] h-[auto] sm:h-[746.96px] bg-transparent border-[1px] border-[#dcb6ff] rounded-[20px] overflow-hidden">
  //         <Image
  //           src="/group 3.png"
  //           alt="Event Gallery"
  //           width={700.03}
