...
{/* <div className="relative bg-[#fdf7ff] overflow-x-hidden">
<div className="absolute top-[2597px] left-0 flex justify-center items-center w-full sm:w-[1910px] sm:h-[1432.5px] opacity-100">
  <Image
    src="/vector 3.svg"
    alt="blank"
    width={1910}
...
<div className="absolute top-[3134px] left-[80px] flex justify-start w-full sm:w-[1531px] sm:h-[678px] opacity-100">
  <Image
    src="/frame 715.png"
    alt="blank"
    width={1531}
...
<div className="absolute top-[3992px] left-[80px] flex flex-col items-center w-full sm:w-[1568px] sm:h-[855px] space-y-[68px] opacity-100 overflow-hidden">
  <Image
    src="/frame 716.png"
    alt="sponsors"
    width={1568}
...
<div className="absolute top-[5027px] left-0 w-full sm:w-[1728px] sm:h-[808px] bg-cover bg-center bg-no-repeat opacity-100 overflow-hidden" style={{
  backgroundImage: `url('/image-mic.png')`,
  backgroundSize: "cover",
  backgroundPosition: "center",
  scrollBehavior: "smooth",
...
<div className="absolute top-[6015px] left-[-5px] flex justify-center items-center w-full sm:w-[1743.5px] sm:h-[587px] opacity-100 overflow-hidden" style={{
  scrollBehavior: "smooth",
}}>
  <Image
    src="/frame 720.png"
...
<div className="absolute top-[6782px] left-[80px] flex justify-center items-center w-full sm:w-[1568px] sm:h-[564px] opacity-100 overflow-hidden" style={{
  scrollBehavior: "smooth",
}}>
  <Image
    src="/frame 613.png"
...
<div className="absolute top-[7526px] left-[114px] flex justify-center items-center w-full sm:w-[1500px] sm:h-[565.54px] opacity-100 overflow-hidden" style={{
  scrollBehavior: "smooth",
}}>
  <Image
    src="/frame 637.png"
...
<div className="absolute top-[8271.54px] left-[80px] w-auto h-auto opacity-100" style={{
  scrollBehavior: "smooth",
}}>
  <p className="text-[45px] font-bold leading-[125%] text-[#000000] font-montserrat">
    FAQs
...
<div className="absolute top-[8406px] left-[174px] flex justify-center items-start w-full sm:w-[1380px] sm:h-[177px] opacity-100 overflow-hidden" style={{
  scrollBehavior: "smooth", 
}}>
  <Image
    src="/frame 272.png"
...
<div className="absolute top-[8732px] left-0 w-full sm:w-[1728px] sm:h-[637px] opacity-100" style={{
  scrollBehavior: "smooth", 
  <Image
    src="/frame 307.png"
    alt="blank"
...
//   return (
//   <div className="relative bg-[#fdf7ff]">
// <div className="absolute top-[2597px] left-0 flex justify-center items-center w-full sm:w-[1910px] sm:h-[1432.5px] opacity-100">
//   <Image
//     src="/vector 3.svg"
//     alt="blank"
